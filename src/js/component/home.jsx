...
const Home = () => {
	...
	return (
		...
		<div className="container text-center d-flex flex-column bg-dark align-items-center rounded justify-content-around" style={{height:400,width:150}}>
			<button type="button" className={"btn rounded-circle "+ colorRojo}  onClick={cambiarColorRojo} style={{height:'100px',width:'100px'}}></button>
			<button type="button" className={"btn rounded-circle "+ colorAmarillo} onClick={cambiarColorAmarillo} style={{height:'100px',width:'100px'}}></button>
			<button type="button" className={"btn rounded-circle "+ colorVerde} onClick={cambiarColorVerde} style={{height:'100px',width:'100px'}}></button>
		</div> 
